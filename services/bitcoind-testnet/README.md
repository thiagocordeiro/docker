...
Original Project: [freewil/bitcoin-testnet-box](https://github.com/freewil/bitcoin-testnet-box)
...
```
$ git clone https://github.com/thiagocordeiro/docker-services.git
$ cd services/bitcoind
$ docker-compose up
```

Access container
```
$ docker exec -i bitcoind bash
```
